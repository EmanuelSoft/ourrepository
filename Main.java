public class Main {
    ...
    void selamawit_Tollera() {
        String name = "selamawit Tollera";
        int id_no = 1056;
        System.out.println(name);
        System.out.println(id_no);
    }
